    ...
    <body class="bg-dark">
        ...
        <div class="container-fluid bg-light page-content">
            ...
            <div class="row content-part">
                ...
                <c:set var="error" value="${ requestScope.ADD_PRODUCT_ERROR }" />
                <form action="addProduct" method="POST" enctype="multipart/form-data"
                  ...
                  <div class="form-row">
                    <div class="form-group col-6">
                      ...
                      <input type="text" class="form-control" id="inputName" 
                             name="txtName" value="${ param.txtName }" required>
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="number" class="form-control" id="inputPrice" min="0"
                             name="txtPrice" value="${ param.txtPrice }" required>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="inputDescription" rows="3" name="txtDescription">${ param.txtDescription }</textarea>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" class="form-control" id="inputQuantity" min="0"
                             name="txtQuantity" value="${ param.txtQuantity }" required >
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select id="inputCategory" class="form-control" name="slCategory">
                        ...
                        <c:forEach var="category" items="${ requestScope.CATEGORY_LIST }">
                            <c:if test="${ param.slCategory eq category.name }">
                                <option selected>${ category.name }</option>
                            </c:if>
                            <c:if test="${ param.slCategory ne category.name }">
                  ...
                  <div class="form-row">
                    <div class="form-group col-6">
                      ...
                      <input type="date" class="form-control" id="inputCreateDate" 
                             name="txtCreateDate" value="${ param.txtCreateDate }" required />
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="date" class="form-control" id="inputExpirationDate" 
                             name="txtExpirationDate" value="${ param.txtExpirationDate }" required />
                  ...
                  <div class="form-row">
                    <div class="form-group col-4">
                       <button type="submit" class="btn btn btn btn-outline-light mr-3">Add Product</button>
                       <button type="button" class="btn btn btn btn-outline-light mr-3" onclick="clearInput()">Reset</button>
                    </div>  
                    <div class="form-group col">
                        <c:if test="${ not empty requestScope.PRODUCT_IMAGE }">
                           <image src="uploads/${ requestScope.PRODUCT_IMAGE }" />
                       </c:if>
                    </div>
                  </div>
